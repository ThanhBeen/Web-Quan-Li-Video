...
<head>
  ...
  <title>Online Entertaiment | Video</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Online Entertaiment</span>
    </a>
					...
					<div class="col-9">
						<div class="row">
							<div class="col-12 form-group">
								...
								<textarea id="description" class="form-control" rows="4">${video != null ? video.title : ''}</textarea>
							</div>
							<div class="col-12 form-group">
